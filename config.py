...
BASE_PATH = os.path.join(Path(__file__).parent.parent, 'MUSE2023_clean', 'packages')
BEST_MODEL_FOLDER = os.path.join(Path(__file__).parent.parent, 'MUSE2023_clean', 'Bestmodels')
WANDB_ENTITY = 'feelsgood_muse'
